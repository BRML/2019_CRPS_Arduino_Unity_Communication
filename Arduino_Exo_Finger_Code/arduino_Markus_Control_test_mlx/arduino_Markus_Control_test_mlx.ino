...
//                                   - Offset_Force_Sensor[iJoints]) * Calib_Force_Sensor[iJoints] * g;
    ...
    double filt = 0; // 0.9990;  // Set only between 1.0 and 0.0.  Higher value filters more. Set to 0.0 to get original, unfiltered version.
...
//  Generate_Assistive_Force(Kinetics[3].x, 3);
  ...
  // Run the admittance control scheme;
...
//    Admittance_Control((EMA_S[0] + EMA_S[1])/2, (Assistive_Force[0].Force_Level+Assistive_Force[1].Force_Level)/2, 0);
//    Admittance_Control((EMA_S[0] + EMA_S[1])/2, (Assistive_Force[0].Force_Level+Assistive_Force[1].Force_Level)/2, 1);
//    Admittance_Control(EMA_S[2] + EMA_S[3], Assistive_Force[2].Force_Level, 2);
//    Admittance_Control(EMA_S[2] + EMA_S[3], Assistive_Force[2].Force_Level, 3);
...
//    Assistive_Force[num].Force_Level = -fMAX_Assistance_Force * 10;
     ...
     if(Assistive_Force[num].Force_Level < fMAX_Assistance_Force && Assistive_Force[num].Direction ==  1)
        Assistive_Force[num].Force_Level = Assistive_Force[num].Force_Level*1000 + 0.001;  // Assistive Force Level incremented to push further forward
    
     if(Assistive_Force[num].Force_Level > -fMAX_Assistance_Force && Assistive_Force[num].Direction == -1)
        Assistive_Force[num].Force_Level = -Assistive_Force[num].Force_Level*1000 - 0.001;  // Assistive Force Level incremented to push further backward
